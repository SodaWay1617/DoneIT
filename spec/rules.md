...
Even in MVP, code should be structured so that projects, subtasks, recurrence, analytics, and additional users can be added without large-scale rewrites.
...
test(task): add integration coverage for daily filtering
